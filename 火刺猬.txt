...
local Window = OrionLib:MakeWindow({Name = "火刺猬脚本", HidePremium = false, SaveConfig = false, IntroText = "欢迎使用", ConfigFolder = "欢迎使用"})
...
Tab:AddParagraph("作者","盐都不盐了")
Tab:AddLabel("作者QQ：3982716135")
Tab:AddLabel("QQ群：1025670075")
...
loadstring(game:HttpGet(' https://raw.githubusercontent.com/M1ZZ001/CabinRoleplay/main/Script'))()
    end
})
...
Tab:AddButton({
    Name = "1",
    Callback = function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/ionlyusegithubformcmods/1-Line-Scripts/main/Slap%20Battles")))()   end
})
...
Tab:AddButton({
	Name = "假延迟",
	Callback = function()
    loadstring(game:HttpGet("https://pastebin.com/raw/riksRExY", true))()
    end
})